...
'Chia sẻ: <a rel="nofollow" href="#" onclick="window.open(\'https://www.facebook.com/sharer/sharer.php?u=\'+encodeURIComponent(location.href), \'facebook-share-dialog\', \'width=626,height=436\'); return false;"> <img src="../media/SVG/facebook.svg" style="max-height:20px;" width="18" height="18" /></a>&nbsp;&nbsp;',
